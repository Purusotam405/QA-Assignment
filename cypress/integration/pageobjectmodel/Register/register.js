...
export default class Register extends BasePage {
  static EmptyFieldsRegister() {
    ...
    cy.get("[data-cy=emptyfields]").should(
      "have.text",
  ...
  static ValidRegisterFields() {
    cy.get("[data-cy=email]")
      .type("purusotam40@gmail.com")
      .should("have.value", "purusotam40@gmail.com");
    cy.get("[data-cy=password]").type("ad1").should("have.value", "ad1");
  ...
  static RegwithExistingEmail() {
    ...
    cy.get('[data-cy="First name"]').type("Pema").should("have.value", "Pema");
    cy.get('[data-cy="last name"]')
      .type("Wangyel")
  ...
  static RegisterValidation() {
    ...
    cy.get("[data-cy=passwordreq]").should(
      "have.text",
      " Password is required "
    );
    cy.get("[data-cy=firstnamereq]").should(
      "have.text",
      " First Name is required "
    );
    cy.get("[data-cy=lastnamereq]").should(
      "have.text",
